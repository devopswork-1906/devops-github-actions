...
output "key_pair_arn" {
  ...
  value       = module.keypair.key_pair_arn
}
...
output "key_pair_fingerprint" {
  ...
  value       = module.keypair.key_pair_fingerprint
}
...
output "public_key_fingerprint_md5" {
  ...
  value       = module.keypair.public_key_fingerprint_md5
}
...
output "public_key_fingerprint_sha256" {
  ...
  value       = module.keypair.public_key_fingerprint_sha256
}
